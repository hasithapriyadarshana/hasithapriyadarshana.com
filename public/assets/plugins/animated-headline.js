jQuery(document).ready(function (s) {
    ...
    if (t.parents(".cd-headline").hasClass("type")) {
      ...
      (function e(n, t, r, c) {
        if (
          ...
          n.is(":last-child") && s("html").hasClass("no-csstransitions"))
        ) {
          var o = d(t);
          l(t, o);
        }
      })(t.find("i").eq(0), t, o, 50),
        n(r.find("i").eq(0), r, o, 50);
    } else
  ...
  (function a(e) {
    e.each(function () {
      ...
      for (i in e)
        a.parents(".rotate-2").length > 0 && (e[i] = "<em>" + e[i] + "</em>"),
